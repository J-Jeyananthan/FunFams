...
Figures from the MSci report, generated by HDBSCAN clustering and contrastive learning experiments across three CATH superfamilies (HUPs 3.40.50.620, aldolases 3.20.20.70, ThDP-binding fold 3.40.50.970).
...
*Generated by: `scripts/hdbscan_benchmark.py` → `scripts/calculate_ec_purity.py`*
...
*Report section: Results — "HDBSCAN achieves comparable or superior functional purity"*  
*Generated by: `scripts/count_funfam_sizes.py`*
...
*Report section: Results — "HDBSCAN achieves comparable or superior functional purity"*  
*Generated by: `scripts/calculate_ec_purity_and_split_proportion.py`*
...
*Generated by: `scripts/hdbscan_benchmark.py` after `scripts/extract_embeddings.py`*
