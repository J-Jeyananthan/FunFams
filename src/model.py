"""Model for funfam contrastive learning."""
...
class FunfamSupConModel(L.LightningModule):
    """Contrastive learning model for funfam classification."""
    
    def __init__(
        self,
        input_dim: int = 1024,
        proj_hidden_dims: Optional[List[int]] = None,
